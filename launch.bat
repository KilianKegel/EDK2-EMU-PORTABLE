...
REM KGTEST set PACKAGES_PATH=%PACKAGES_PATH%;%WORKSPACE%
set PACKAGES_PATH=%PACKAGES_PATH%;%WORKSPACE%\overrides\EDK2
rem set PACKAGES_PATH=%PACKAGES_PATH%;%WORKSPACE%\overrides\EDK2\MdeModulePkg\Universal\Variable
rem set PACKAGES_PATH=%PACKAGES_PATH%;%WORKSPACE%\overrides\EDK2-platforms
set PACKAGES_PATH=%PACKAGES_PATH%;%WORKSPACE%\overrides\EmulatorPkg
rem set PACKAGES_PATH=%PACKAGES_PATH%;%WORKSPACE%\Visual-TORO-C-LIBRARY-for-UEFI

rem set PACKAGES_PATH=%PACKAGES_PATH%;%WORKSPACE%\overrides\EDK2-non-osi\Silicon\Intel
